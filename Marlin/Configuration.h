...
#define STRING_CONFIG_H_AUTHOR "(github.com/tmacinc)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 19.36
  #define DEFAULT_bedKd 372.41
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -10, -1.05 }
